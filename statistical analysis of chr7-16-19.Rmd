...
# reading the files of chr6-16-19
...
library(dplyr)
library(janitor)
chr7 <- read_tsv("../chr7.tsv", col_types = cols(.default = "c")) %>% clean_names()
chr16 <- read_tsv("../chr16.tsv", col_types = cols(.default = "c")) %>% clean_names()
chr19 <- read_tsv("../chr19.tsv", col_types = cols(.default = "c")) %>% clean_names()
